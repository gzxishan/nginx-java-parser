...
public class NginxConfigParser implements NginxConfigParserConstants
{
    ...
    /*
      Main method
    */
    final public NgxConfig parse() throws ParseException
    {
        NgxConfig config;
        config = statements();
        {
    ...
    final public NgxConfig statements() throws ParseException
    {
    ...
    */
    final public NgxBlock block() throws ParseException
    {
        String blockName = "";
    ...
    */
    final public NgxBlock if_block() throws ParseException
    {
    ...
    */
    final public NgxParam param() throws ParseException
    {
    ...
    /*
      ...
      # Comment here
    */
    final public NgxComment comment() throws ParseException
    {
        NgxComment comment;
    ...
    */
    final public NgxToken id() throws ParseException
    {
        NgxToken val = null;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk)
        {
    ...
    /*
      Parameter values
    */
    final public NgxToken value() throws ParseException
    {
        NgxToken val = null;
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk)
        {
